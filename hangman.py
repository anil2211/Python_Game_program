...
someWords='''
apple banana mango strwaberry orange grapes lemon cherry berry papaya
'''
someWords=someWords.split(' ')
word=random.choice(someWords)

if __name__ =="__main__":
    print('Guess the word!,HINT: word is name of fruits')
    ...
    playing=True
    # List for storing thr  letters guessed by the player
    letterGuessed=''
    chances=len(word)+2
    correct=0
    flag=0
